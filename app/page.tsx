  ...
  return (
    <>
      ...
      <section className="relative w-full h-[70vh] min-h-[450px] flex items-center justify-center text-white">
        ...
        />
        <div className="absolute top-0 left-0 w-full h-full bg-ink opacity-60 z-10" />
        <div className="relative z-20 container mx-auto flex flex-col items-center text-center px-4">
          ...
          <p className="mt-6 max-w-3xl text-lg md:text-xl font-body text-white/80 leading-relaxed">
            The future of writing belongs to those who blend timeless craft with powerful technology. Our primary focus is teaching you to leverage
            generative AI as a revolutionary creative partner. But we do it by grounding every lesson in the foundational principles of a Master of
            Fine Arts education—from building a compelling character arc to mastering narrative momentum. We are making the core of an MFA
            accessible, helping you build an unshakeable foundation before you launch your voice into the future.
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {aiTools.map((tool) => (
              ...
              >
                <div className={`p-4 ${tool.bgColor} rounded-full mb-4`}>{tool.icon}</div>
                <h3 className="font-display text-xl font-bold mb-2">{tool.title}</h3>
                <p className="font-body text-ink/80 dark:text-canvas/80 text-sm flex-grow">{tool.description}</p>
                <a
                  href={tool.href}
                  target="_blank"
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center font-display mb-12">Explore the Retreat</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-8 hover:border-glow transition-colors hover:shadow-lg">
              ...
              <p className="font-body text-ink/80 dark:text-canvas/80">Learn to collaborate with AI through structured lessons and projects.</p>
            </div>
            <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-8 hover:border-glow transition-colors hover:shadow-lg">
              <h3 className="font-display text-xl font-bold mb-2">AI Tools &amp; Custom GPTs</h3>
              <p className="font-body text-ink/80 dark:text-canvas/80">Use our pre-trained AI writing partners or build your own custom muse.</p>
            </div>
            <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-8 hover:border-glow transition-colors hover:shadow-lg">
              <h3 className="font-display text-xl font-bold mb-2">Explore Genres</h3>
              <p className="font-body text-ink/80 dark:text-canvas/80">Find tools and community spaces tailored to your chosen craft.</p>
            </div>
          </div>
        </div>
      </section>
