import { lessons } from "@/lib/lessons"; // Import lesson content
import Link from "next/link";
import { notFound } from "next/navigation";

// Sidebar listing the course navigation. The curriculum here mirrors the lesson order.
...
// The page component for a single lesson. It renders the sidebar and the selected lesson content.
          ...
          <header className="mb-10 pb-6 border-b border-gray-200 dark:border-gray-800">
            ...
            {lesson!.meta && (
              <div className="mt-4 text-sm text-ink/70 dark:text-canvas/70 space-y-1">
                <p>
                  <strong>Program:</strong> {lesson!.meta.program}
                </p>
                <p>
                  <strong>Position:</strong> {lesson!.meta.position}
                </p>
                <p>
                  <strong>Estimated Time Commitment:</strong> {lesson!.meta.time}
                </p>
                <p>
                  <strong>Prerequisites:</strong> {lesson!.meta.prerequisites}
                </p>
              </div>
            )}
          </header>
