...
const books = [
    // AI Books
    { title: 'Write with AI', author: 'Rob Kosberg (2024)', category: 'AI Books', description: 'Conquer writer\'s block, unleash your creativity, and write your book using artificial intelligence.' },
    { title: 'The Rise of the AI Author', author: 'Eldar Haber (2025)', category: 'AI Books', description: 'The complete guide to writing with artificial intelligence.' },
    { title: 'Co-Intelligence', author: 'Ethan Mollick (2024)', category: 'AI Books', description: 'The definitive, bestselling guide to living and working with AI.' },
    { title: 'AI Snake Oil', author: 'A. Narayanan & S. Kapoor (2024)', category: 'AI Books', description: 'What artificial intelligence can do, what it can’t, and how to tell the difference.' },
    // Writing Fundamentals
    { title: 'On Writing: A Memoir of the Craft', author: 'Stephen King (2020)', category: 'Fundamentals', description: 'This seminal work fuses autobiography with practical writing wisdom. King\'s core message remains powerfully direct: "If you want to be a writer, you must do two things above all others: read a lot and write a lot".' },
    { title: 'Bird by Bird', author: 'Anne Lamott (1994)', category: 'Fundamentals', description: 'Lamott champions breaking down daunting writing projects into manageable pieces—tackling them "bird by bird." The book confronts the psychological hurdles inherent in writing, from crippling perfectionism to gnawing self-doubt.' },
        ...
        <div className="container mx-auto px-4 py-12 md:py-16">
            <div className="text-center">
                ...
                <div className="mt-6 max-w-3xl mx-auto space-y-4 font-body text-ink/80 dark:text-canvas/80 leading-relaxed">
                    <p>Pursuing a Master of Fine Arts in writing is more than an academic path; it's an intensive journey demanding both technical mastery and a refined artistic vision. To navigate this challenging pursuit, certain books stand as indispensable guides.</p>
                    <p className="text-sm italic">AI Writers’ Retreat offers these book recommendations independently. We receive no affiliation or sponsorship from the authors or booksellers mentioned.</p>
                </div>
            </div>
